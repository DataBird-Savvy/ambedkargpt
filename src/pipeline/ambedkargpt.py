...
class AmbedkarGPTPipeline:
    def __init__(self, config_path="config.yaml"):
        try:
            ...
            raise RAGException(f"Failed to initialize AmbedkarGPTPipeline: {e}", sys)
    ...
    def _load_graph(self):
        try:
            ...
            raise RAGException(f"Failed to load knowledge graph: {e}", sys)
    ...
    def _load_chunks(self):
        try:
            ...
            raise RAGException(f"Failed to load chunks: {e}", sys)
    ...
    def _load_json(self, path):
        try:
            ...
            raise RAGException(f"Failed to load JSON from {path}: {e}", sys)
    ...
    def run(self, query: str) -> str:
        try:
            ...
            raise RAGException(f"Pipeline run failed: {e}", sys)
